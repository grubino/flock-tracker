 ...
 */
import type { AnimalBriefName } from './animalBriefName';
import type { AnimalType } from './animalType';
import type { AnimalBriefSheepGender } from './animalBriefSheepGender';
...
export interface AnimalBrief {
  id: number;
  name?: AnimalBriefName;
  tag_number: string;
  animal_type: AnimalType;
  sheep_gender?: AnimalBriefSheepGender;
}
