 ...
 */
import type { PhotographBriefCaption } from './photographBriefCaption';
import type { PhotographBriefWidth } from './photographBriefWidth';
import type { PhotographBriefHeight } from './photographBriefHeight';

/**
 * Brief photograph info for nested responses
 */
export interface PhotographBrief {
  id: number;
  filename: string;
  file_path: string;
  caption?: PhotographBriefCaption;
  is_primary: boolean;
  width?: PhotographBriefWidth;
  height?: PhotographBriefHeight;
}
