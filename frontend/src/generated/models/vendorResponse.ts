 ...
 */
import type { VendorResponseAddress } from './vendorResponseAddress';
import type { VendorResponsePhone } from './vendorResponsePhone';
import type { VendorResponseWebsite } from './vendorResponseWebsite';

export interface VendorResponse {
  /** @minLength 1 */
  name: string;
  address?: VendorResponseAddress;
  phone?: VendorResponsePhone;
  website?: VendorResponseWebsite;
  id: number;
  created_at: string;
  updated_at: string;
}
