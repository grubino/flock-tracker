 ...
 */
import type { ExpenseLineItemResponseCategory } from './expenseLineItemResponseCategory';
import type { ExpenseLineItemResponseQuantity } from './expenseLineItemResponseQuantity';
import type { ExpenseLineItemResponseUnitPrice } from './expenseLineItemResponseUnitPrice';

export interface ExpenseLineItemResponse {
  /** @minLength 1 */
  description: string;
  category?: ExpenseLineItemResponseCategory;
  quantity?: ExpenseLineItemResponseQuantity;
  unit_price?: ExpenseLineItemResponseUnitPrice;
  amount: string;
  id: number;
}
