...
Revision ID: d5f7e8a9b1c2
Revises: 8418e9fb7f09
Create Date: 2025-10-05 09:45:00.000000
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'PROCESSING', 'READY', 'COMPLETED', 'CANCELLED', name='orderstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('is_backorder', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=True),
